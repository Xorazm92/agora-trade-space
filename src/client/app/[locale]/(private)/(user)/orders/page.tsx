      ...
      <div className="p-3 sm:p-4 lg:p-6">
        ...
        {order.orderItems && order.orderItems.length > 0 && (
          <div className="mb-3 sm:mb-4">
            <p className="text-xs text-gray-500 mb-1 sm:mb-2">Mahsulotlar:</p>
            <div className="space-y-1">
              ...
              {order.orderItems.length > 2 && (
                <p className="text-xs text-gray-400">
                  +{order.orderItems.length - 2} ta ko'proq mahsulot
                </p>
              )}
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-lg text-red-500">
              Buyurtmalarni yuklashda xatolik: {"Noma'lum xatolik"}
            </p>
          </div>
        ) : orders.length === 0 ? (
          <div className="text-center py-12">
            <Package size={48} className="mx-auto text-gray-400 mb-4" />
            <p className="text-lg text-gray-600">Sizda hali buyurtmalar yo'q</p>
            <Link
              href="/products"
          ...
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="text-base sm:text-lg text-gray-600">
              Filtrlaringizga mos buyurtmalar topilmadi
            </p>
            <button
