...
const HeroSection = ({ isPreview = false }: HeroSectionProps) => {
  ...
  const sliderData = [
    {
      image: SliderImg1,
      title: "Ajoyib takliflarni kashf eting",
    ...
    {
      image: SliderImg3,
      title: "Tez va bepul yetkazish",
      subtitle: "100,000 so'mdan yuqori buyurtmalarga",
      ctaText: "Batafsil",
      ctaLink: "/shop",
    ...
    {
      image: SliderImg4,
      title: "Bolalar uchun xavfsiz mahsulotlar",
      subtitle: "0-12 yosh bolalar uchun sifatli tanlov",
